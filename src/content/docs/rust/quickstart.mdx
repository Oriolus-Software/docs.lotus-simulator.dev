...
`lotus-sc` is a CLI tool that helps you develop scripts for LOTUS. You can download the installer from [here](http://nexus.lotus-simulator.dev/assets/lotus-sc-installer/lotus-sc-installer.exe). For more information, please refer to the [lotus-sc documentation](/lotus-sc/overview/).
...
See the [scripts.toml reference](/lotus-sc/configuration) for more information.
